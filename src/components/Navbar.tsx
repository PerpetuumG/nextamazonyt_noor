...
const Navbar = () => {
  ...
  return (
    <div
      className={
        'w-full h-20 border-b-[1px] border-b-zinc-500 bg-white text-zinc-600 sticky top-0 z-50 bg-white/80 backdrop-blur-2xl'
      }
    >
      <div
      ...
      >
        ...
        <div className={'flex items-center gap-x-5'}>
          ...
          >
            ...
            <span
              className={
                'absolute top-0 -left-1 bg-zinc-800 text-zinc-200 w-4 h-4 rounded-full text-xs flex items-center justify-center group-hover:bg-black font-semibold group-hover:text-white'
              }
            >
              0
            </span>
