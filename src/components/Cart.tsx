      ...
      {productData.length > 0 ? (
        <div className={'mt-5 flex flex-col'}>
                ...
                <tbody key={item?._id}>
                  <tr className={'bg-white border-b-[1px] border-b-zinc-300'}>
                    ...
                    <td className={'px-6 py-4 flex items-center gap-4'}>
                      <span
                        className={
                          'border border-zinc-300 p-1 rounded-md hover:border-zinc-800 cursor-pointer duration-200 inline-flex items-center justify-center'
                        }
                      >
                        <Minus
                          onClick={() =>
                    ...
                    <td className={'px-6 py-4'}>
                      <p
                        className={
                          'bg-zinc-900 w-20 text-sm font-semibold text-center text-white py-1 rounded-md'
                        }
                      >
          ...
          <button
            onClick={handleReset}
            className={
              'bg-zinc-950 text-zinc-200 w-36 py-3 mt-5 rounded-md uppercase text-xs font-semibold hover:bg-red-700 hover:text-white duration-200'
            }
          >
            Reset Cart
          </button>
          ...
          <div className={'mt-4 bg-white max-w-xl p-4 flex flex-col gap-1'}>
            ...
            <p className={'flex items-center justify-between'}>
              Discount{' '}
              <span>
                <FormattedPrice amount={rowPrice - totalAmount} />
              </span>
            </p>
            ...
            <p className={'flex items-center justify-between'}>
              Total Price{' '}
              <span>
                <FormattedPrice amount={totalAmount} className={'font-semibold text-lg'} />
              </span>
            </p>
            ...
            <button
              ...
              className={
                'bg-zinc-800 text-zinc-200 my-2 py-2 uppercase text-center rounded-md font-semibold hover:bg-black hover:text-white duration-200'
              }
            >
              Proceed to Checkout
            </button>
        ...
        <div className={'py-10 flex flex-col gap-1 items-center justify-center'}>
          ...
          <Link
            href={'/'}
            className={
              'text-sm uppercase font-semibold underline underline-offset-2 hover:text-designColor duration-200 cursor-pointer'
            }
          >
            Go back to Shopping
          </Link>
